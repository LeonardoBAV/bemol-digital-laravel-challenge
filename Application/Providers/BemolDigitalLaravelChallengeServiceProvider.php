...
namespace Modules\BemolDigitalLaravelChallenge\Application\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use Modules\BemolDigitalLaravelChallenge\Domain\Entities\User;
use Modules\BemolDigitalLaravelChallenge\Domain\Observers\UserObserver;

class BemolDigitalLaravelChallengeServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'BemolDigitalLaravelChallenge';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'bemoldigitallaravelchallenge';
